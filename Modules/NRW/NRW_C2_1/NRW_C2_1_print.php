...
class NRW_C2_1_print implements IPrintTemplate
{
...
<div class="report">
    ...
    <div class="report-content">
        ...
        <div class="print-lernverhalten">
            <b>Aussagen zum Arbeits- und Sizialverhalten und zu Lernentwicklung und Leistungsstand:</b><br>
            ' . $this->model->getAussagenArbeitsSozialverhaltenLernentwicklung() . '
        </div>
